...
public:
	...
	virtual void VisitKeys
	(
		RE::TESObjectREFR* actor, const char* name, MorphKeyVisitor& visitor
	) = 0;
	virtual void VisitMorphValues
	(
		RE::TESObjectREFR* actor, MorphValueVisitor& visitor
	) = 0;

	virtual void ClearMorphs(RE::TESObjectREFR* actor) = 0;

	virtual void ApplyVertexDiff
	(
		RE::TESObjectREFR* refr, 
...
public:
	...
	virtual bool HasNodeTransformPosition
	(
	...
	virtual bool HasNodeTransformRotation
	(
		RE::TESObjectREFR* ref,
		bool firstPerson, 
		bool isFemale, 
	...
	virtual bool HasNodeTransformScale
	(
		RE::TESObjectREFR* ref, 
		bool firstPerson, 
		bool isFemale,
	...
	virtual bool HasNodeTransformScaleMode
	(
		RE::TESObjectREFR* ref,
		bool firstPerson,
		bool isFemale, 
	...
	virtual void AddNodeTransformPosition
	(
		RE::TESObjectREFR* ref, 
		bool firstPerson, 
		bool isFemale, 
	...
	virtual void AddNodeTransformScale
	(
		RE::TESObjectREFR* ref, 
		bool firstPerson, 
		bool isFemale, 
	...
	virtual void AddNodeTransformScaleMode
	(
		RE::TESObjectREFR* ref,
		bool firstPerson,
		bool isFemale,
	...
	virtual Position GetNodeTransformPosition
	(
		RE::TESObjectREFR* ref,
		bool firstPerson,
		bool isFemale, 
	...
	virtual Rotation GetNodeTransformRotation
	(
		RE::TESObjectREFR* ref,
		bool firstPerson, 
		bool isFemale, 
	...
	virtual float GetNodeTransformScale
	(
		RE::TESObjectREFR* ref,
		bool firstPerson, 
		bool isFemale, 
	...
	virtual skee_u32 GetNodeTransformScaleMode
	(
		RE::TESObjectREFR* ref,
		bool firstPerson, 
		bool isFemale,
	...
	virtual bool RemoveNodeTransformPosition
	(
		RE::TESObjectREFR* ref, 
		bool firstPerson, 
		bool isFemale, 
	...
	virtual bool RemoveNodeTransformRotation
	(
		RE::TESObjectREFR* ref,
		bool firstPerson,
		bool isFemale,
	...
	virtual bool RemoveNodeTransformScale
	(
		RE::TESObjectREFR* ref,
		bool firstPerson,
		bool isFemale,
	...
	virtual bool RemoveNodeTransformScaleMode
	(
		RE::TESObjectREFR* ref,
		bool firstPerson, 
		bool isFemale, 
	...
	virtual bool RemoveNodeTransform
	(
		RE::TESObjectREFR* refr,
		bool firstPerson,
		bool isFemale, 
	...
	virtual bool GetOverrideNodeTransform
	(
		RE::TESObjectREFR* refr, 
		bool firstPerson, 
		bool isFemale, 
	...
	(
		RE::TESObjectREFR* refr, bool firstPerson, bool isFemale, NodeVisitor& visitor
	) = 0;
...
public:
	...
	// Use this data structure to form an item query, 
	// this will identify a specific item through various means
	struct Identifier
	{
		enum
		{
	...
	(
		RE::TESObjectREFR* reference, Identifier& identifier, bool makeUnique
	) = 0; // Make unique will create an identifier if it does not exist for the specified item
	virtual void SetItemTextureLayerColor
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex, skee_u32 color
	) = 0;
	virtual void SetItemTextureLayerType
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex, skee_u32 type
	) = 0;
	virtual void SetItemTextureLayerBlendMode
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex, const char* blendMode
	) = 0;
	virtual void SetItemTextureLayerTexture
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex, const char* texture
	) = 0;

	virtual skee_u32 GetItemTextureLayerColor
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex
	) = 0;
	virtual skee_u32 GetItemTextureLayerType
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex
	) = 0;
	virtual bool GetItemTextureLayerBlendMode
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex, StringVisitor& visitor
	) = 0;
	virtual bool GetItemTextureLayerTexture
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex, StringVisitor& visitor
	) = 0;

	virtual void ClearItemTextureLayerColor
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex
	) = 0;
	virtual void ClearItemTextureLayerType
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex
	) = 0;
	virtual void ClearItemTextureLayerBlendMode
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex
	) = 0;
	virtual void ClearItemTextureLayerTexture
	(
		skee_u32 uniqueID, skee_i32 textureIndex, skee_i32 layerIndex
	) = 0;
	virtual void ClearItemTextureLayer
	(
		skee_u32 uniqueID, skee_i32 textureIndex
	) = 0;
...
{
public:
	// Return true indicates callback was handled and not to proceed 
	// to next command with the same command name
...
public:
	...
	// Version 2
	using FlushCallback = void (*)(skee_u32* formId, skee_u32 length); 
	// Array of FormIDs of length
...
public:
	...
	(
		RE::TESObjectREFR* reference, bool resetDiffuse, bool defer = true
	) = 0;
	...
	(
		...
		const char* nodeName,
		skee_u32 partType,
		skee_u32 shaderType, bool resetDiffuse, bool defer = true) = 0;
...
public:
	...
	virtual bool HasArmorAddonNode
	(
		RE::TESObjectREFR* refr, 
		bool firstPerson, 
		RE::TESObjectARMO* armor,
	...
	virtual void RemoveArmorOverride
	(
		RE::TESObjectREFR* refr,
		bool isFemale,
		RE::TESObjectARMO* armor, 
	...
	virtual void ApplyArmorOverrides
	(
		RE::TESObjectREFR* refr, 
		RE::TESObjectARMO* armor, 
		RE::TESObjectARMA* addon, 
	...
	virtual void RemoveAllArmorOverridesByArmor
	(
		RE::TESObjectREFR* refr, bool isFemale, RE::TESObjectARMO* armor
	) = 0;
	virtual void RemoveAllArmorOverridesByAddon
	(
		RE::TESObjectREFR* refr, bool isFemale, RE::TESObjectARMO* armor, RE::TESObjectARMA* addon
	) = 0;
	virtual void RemoveAllArmorOverridesByNode
	(
		RE::TESObjectREFR* refr, 
		bool isFemale, 
		RE::TESObjectARMO* armor, 
	...
	virtual void RemoveNodeOverride
	(
		RE::TESObjectREFR* refr, 
		bool isFemale, 
		const char* nodeName, 
	...
	virtual void ApplyNodeOverrides
	(
		RE::TESObjectREFR* refr, RE::NiAVObject* object, bool immediate
	) = 0;
	virtual void RemoveAllNodeOverrides() = 0;
	virtual void RemoveAllNodeOverridesByReference(RE::TESObjectREFR* reference) = 0;
	virtual void RemoveAllNodeOverridesByNode
	(
		RE::TESObjectREFR* refr, bool isFemale, const char* nodeName
	) = 0;

	virtual bool HasSkinOverride
	(
		RE::TESObjectREFR* refr,
		bool isFemale, 
		bool firstPerson,
	...
	virtual void RemoveSkinOverride
	(
		RE::TESObjectREFR* refr,
		bool isFemale, 
		bool firstPerson, 
	...
	virtual void ApplySkinOverrides
	(
		RE::TESObjectREFR* refr,
		bool firstPerson, 
		RE::TESObjectARMO* armor, 
	...
	virtual void RemoveAllSkinOverridesBySlot
	(
		RE::TESObjectREFR* refr, bool isFemale, bool firstPerson, skee_u32 slotMask
	) = 0;
};
...
public:
	...
	enum ApplyTypes
	{
		...
		(
			kPresetApplyFace |
			kPresetApplyOverrides | 
			kPresetApplyBodyMorphs |
			kPresetApplyTransforms | 
	...
	(
		...
		const char* tintPath, 
		RE::Actor* actor, 
		ApplyTypes applyTypes = kPresetApplyAll
	) = 0; // Details may be saved to the TESNPC, make sure this character is unique!
};
...
public:
	...
	virtual bool AddPartTag(std::uint32_t partType, const char* tag, const char* label) = 0;
	virtual bool RemovePartTag(std::uint32_t partType, const char* tag) = 0;
	virtual bool HasPartTags(std::uint32_t partType) = 0;
	virtual bool HasPartTag(std::uint32_t partType, const char* tag) = 0;
	...
	virtual void GetPartTags(std::uint32_t partType, PartTagVisitor& visitor) = 0;
};
