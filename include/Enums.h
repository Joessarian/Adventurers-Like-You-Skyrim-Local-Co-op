...
namespace ALYSLC
{
	...
	// Special info when processing emulated input events.
	...
	enum class EmulatedInputEventInfo
	{
		kNone,					// No special handling. Regular event queued by the game.
		kHandled,				// Already handled and processed by a MenuControls hook.
		kP1AllowThrough,		// Generated as an input event for P1 and should not be ignored.
		kFromCompanionPlayer,	// Generated by a companion player and should not be ignored.
		kIgnore					// Skip handling the event.
	};
