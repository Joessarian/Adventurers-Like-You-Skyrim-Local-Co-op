...
namespace ALYSLC
{
	namespace SerializationCallbacks
	{
		...
		// Attempt to retrieve a float value with the given record type and store in the data outparam.
		void RetrieveFloatData(SKSE::SerializationInterface* a_intfc, float& a_data, const uint32_t& a_recordType);

		// Attempt to retrieve a fixed string with the given record type from the SKSE co-save and store in the data outparam.
		...
		// Attempt to retrieve an unsigned 8-bit integer with the given record type from the SKSE co-save and store in the data outparam.
		void RetrieveUInt8Data(SKSE::SerializationInterface* a_intfc, uint8_t& a_data, const uint32_t& a_recordType);

		// Attempt to retrieve an unsigned 16-bit integer with the given record type from the SKSE co-save and store in the data outparam.
		void RetrieveUInt16Data(SKSE::SerializationInterface* a_intfc, uint16_t& a_data, const uint32_t& a_recordType);

		// Attempt to retrieve an unsigned 32-bit integer with the given record type from the SKSE co-save and store in the data outparam.
		void RetrieveUInt32Data(SKSE::SerializationInterface* a_intfc, uint32_t& a_data, const uint32_t& a_recordType);

		// Called on "PreLoadGame' and when going back to the main menu. Tear down any active co-op session.
		void Revert(SKSE::SerializationInterface* a_intfc);

		// Called when the game is saved. Save all our serializable data.
		void Save(SKSE::SerializationInterface* a_intfc);

		// Attempt to serialize a float value of the given record type to the SKSE co-save.
		void SerializePlayerFloatData(SKSE::SerializationInterface* a_intfc, const float& a_data, const uint32_t& a_recordType);

		// Attempt to serialize a string of the given record type to the SKSE co-save.
		...
		// Attempt to serialize an unsigned 8-bit integer of the given record type to the SKSE co-save.
		void SerializePlayerUInt8Data(SKSE::SerializationInterface* a_intfc, const uint8_t& a_data, const uint32_t& a_recordType);

		// Attempt to serialize an unsigned 16-bit integer of the given record type to the SKSE co-save.
		void SerializePlayerUInt16Data(SKSE::SerializationInterface* a_intfc, const uint16_t& a_data, const uint32_t& a_recordType);

		// Attempt to serialize an unsigned 32-bit integer of the given record type to the SKSE co-save.
		void SerializePlayerUInt32Data(SKSE::SerializationInterface* a_intfc, const uint32_t& a_data, const uint32_t& a_recordType);

		// Serialize default player data to the SKSE co-save if no data exists for all players,
