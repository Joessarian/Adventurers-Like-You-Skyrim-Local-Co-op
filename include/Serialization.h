...
namespace ALYSLC
{
	namespace SerializationCallbacks
	{
		...
		// Attempt to retrieve a fixed string of the given size and record type and store in the data outparam.
		...
		// Attempt to retrieve an unsigned 8-bit integer with the given record type and store in the data outparam.
		void RetrieveUInt8Data(SKSE::SerializationInterface* a_intfc, uint8_t& a_data, const uint32_t& a_recordType);

		// Attempt to retrieve an unsigned 16-bit integer with the given record type and store in the data outparam.
		void RetrieveUInt16Data(SKSE::SerializationInterface* a_intfc, uint16_t& a_data, const uint32_t& a_recordType);

		// Attempt to retrieve an unsigned 32-bit integer with the given record type and store in the data outparam.
